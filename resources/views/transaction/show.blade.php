...
<div class="card-body">
            ...
            <div class="col mb-3">
                ...
                <div class="input-group input-group-merge">
                    <input type="date" name="submission" class="form-control"
                        id="basic-icon-default-fullname" value="{{ $transaction->submission }}" readonly>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col mb-3">
                ...
                <div class="input-group input-group-merge">
                    <input type="date" name="return" class="form-control" value="{{ $transaction->return }}" id="basic-icon-default-fullname" readonly>
                </div>
                @error('return')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
        ...
        <div class="row">
            ...
            <div class="col mb-3">
                ...
                <div class="input-group input-group-merge">
                    <input type="text" name="description" class="form-control" value="{{ $transaction->description }}" id="basic-icon-default-fullname" readonly>
                </div>
                @error('description')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
        ...
        <div class="card-body">
            ...
            <ul class="list-unstyled mb-4 mt-3">
                ...
                <li class="d-flex mb-3"><i class='bx bx-credit-card-front'></i><small
                        class="fw-semibold mx-2">ISBN:</small> <small>{{ $transaction->book->isbn }}</small></li>
                ...
                <li class="d-flex mb-3"><i class='bx bxs-user-rectangle'></i><small
                        class="fw-semibold mx-2">Penulis:</small> <small>{{ $transaction->book->author }}</small>
                </li>
                ...
                <li class="d-flex mb-3"><i class='bx bx-list-ol'></i><small
                        class="fw-semibold mx-2">Stok:</small> <small>{{ $transaction->book->stock }}</small></li>
            </ul>
