                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="code" class="form-control"
                                        id="basic-icon-default-fullname" value="{{ $category->code }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                        id="basic-icon-default-code" value="{{ $category->name }}">
                                </div>
                            </div>
                        </div>
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($categories as $no => $item)
                        <tr>
                            ...
                            <td>{{ $item->code }}</td>
                            <td>{{ $item->name }}</td>
                            <td class="d-flex justify-content-center gap-1"><a href="/category/{{ $item->id }}/edit"
