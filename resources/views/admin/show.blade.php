    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-0">
                ...
                <li class="d-flex d-none  align-items-center mb-3"><i class="bx bx-customize"></i><span
                        class="fw-semibold mx-2">Denda:</span> <span>146</span></li>
                <li class="d-flex align-items-center"><i class="bx bx-user"></i><span
                        class="fw-semibold mx-2">Keanggotaan:</span> <span>@if ($user->isAdmin == 0)
                            Anggota
                        @else
                            Administrator
                        @endif</span></li>
