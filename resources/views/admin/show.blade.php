...
<div class="col-xl-8 col-lg-7 col-md-7">
    <div class="card mb-4">
        <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-0">
                ...
                <li class="d-flex d-none  align-items-center mb-3"><i class="bx bx-customize"></i><small
                        class="fw-semibold mx-2">Denda:</small> <small>146</small></li>
                <li class="d-flex align-items-center"><i class="bx bx-user"></i><small
                        class="fw-semibold mx-2">Keanggotaan:</small> <small>@if ($user->isAdmin == 0)
                            Anggota
                        @else
                            Administrator
                        @endif</small></li>
    ...
    <div class="d-flex gap-4 justify-content-start">
        <a class="btn btn-secondary" href="/admin" role="button"><i
            class="bx bx-arrow-back bx-xs"></i> Kembali</a>
    @include('admin.edit')
