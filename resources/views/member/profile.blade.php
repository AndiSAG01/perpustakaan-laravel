        ...
        <div class="col-md-12">
            <div class="card mb-4">
              ...
              <div class="d-flex align-items-start align-items-sm-center gap-4">
                <img src="..https://api.dicebear.com/5.x/adventurer/svg?seed=Felix/{{ rand(1, 999)}}" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="number" id="noId" name="noId"
                                value="{{ Auth::user()->noId }}" autofocus="" disabled>
                        </div>
                        <div class="mb-3 col-md-6">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="date" id="birthday" name="birthday"
                                value="{{ Auth::user()->birthday }}" disabled>
                        </div>
                        <div class="mb-3 col-md-6">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="gender" id="1"
                                    value="1" @if (Auth::user()->telp == true) checked @endif disabled>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="gender" id="0"
                                    value="0" @if (Auth::user()->telp == false) checked @endif disabled>
