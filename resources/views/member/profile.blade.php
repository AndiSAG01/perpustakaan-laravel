            ...
            <div class="card-body">
                <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    <input class="form-control" type="number" id="noId" name="noId" value="{{ Auth::user()->noId }}" autofocus="" disabled>
                  </div>
                  <div class="mb-3 col-md-6">
                  ...
                  <div class="mb-3 col-md-6">
                    ...
                    <input class="form-control" type="date" id="birthday" name="birthday" value="{{ Auth::user()->birthday }}" disabled>
                  </div>
                  <div class="mb-3 col-md-6">
                    <label for="address" class="form-label">Alamat</label>
                    <input class="form-control" type="text" id="address" name="address" value="{{ Auth::user()->address }}" disabled>
                  </div>
                  <div class="mb-3 col-md-6">
                    <label for="telp" class="form-label">Telp</label>
                    <input class="form-control" type="number" id="telp" name="telp" value="{{ Auth::user()->telp }}" disabled>
                  </div>
